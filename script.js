...
function addNotes(){
    ...
    if(notes === null){
        ...
        notes = JSON.parse(notes);//converting from string to array
    }
    ...
    addText.value = '';
    notes.push(noteObj);
    localStorage.setItem('notes', JSON.stringify(notes));//converting into string show that can store in localstorage and here it is also getting updated
    showNotes();
}
